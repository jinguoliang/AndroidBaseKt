...
var View.layoutStart: Int
    get() = (layoutParams as FrameLayout.LayoutParams).marginStart
    set(start) {
        layoutParams = (layoutParams as FrameLayout.LayoutParams).apply { if (marginStart != start) marginStart = start }
    }
